    ...
    <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#1a1a1a;">
      <div style="background:#1e2d4a;padding:24px 32px;border-radius:12px 12px 0 0;">
        ...
        <p style="color:rgba(255,255,255,0.6);margin:6px 0 0;font-size:14px;">
          Advance Pristine Painting &nbsp;·&nbsp; ${sentAt}
        </p>
      </div>
      <div style="background:#fff;padding:28px 32px;border:1px solid #ddd8ce;border-top:none;">
        <h2 style="font-size:13px;text-transform:uppercase;letter-spacing:0.1em;color:#d94f1e;margin:0 0 14px;">Contact Information</h2>
        ...
        <h2 style="font-size:13px;text-transform:uppercase;letter-spacing:0.1em;color:#d94f1e;margin:0 0 14px;">Project Details</h2>
        <table style="width:100%;border-collapse:collapse;margin-bottom:24px;">
          <tr>
      ...
      <div style="background:#f8f6f2;padding:14px 32px;border-radius:0 0 12px 12px;border:1px solid #ddd8ce;border-top:none;text-align:center;">
        <p style="margin:0;font-size:12px;color:#999;">Submitted via the estimate form on advancepristinepainting.com</p>
      </div>
    </div>
  `;
